...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['account-owner', 'customer-support', 'bank-employee', 'branch-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Atm', path: '/atms', entity: 'atm', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    {
      name: 'Bank Account',
      path: '/bank-accounts',
      entity: 'bank_account',
    ...
    { name: 'Branch', path: '/branches', entity: 'branch', service: AccessServiceEnum.PROJECT, icon: FiMap },
